...
{
    [DbContext(typeof(JobSagaRunnerDbContext))]
    [Migration("20250312081709_Initial")]
            ...
            modelBuilder.Entity("MassTransit.JobAttemptSaga", b =>
                {
                    ...
                    b.ToTable("job_attempt_saga", "jobs");
                });
